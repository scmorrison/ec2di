...
var ec2di = function(configFile) {
  ...
  var doApiCallsUpdateCache = function() {
    ...
    return new Promise(function(resolve, reject) {
      ...
      _useRoute53RecordsCheck().then(function() {
          // are we going to need route53records?
          // next, return valid regions for the next step
          return _getRegions();
        })
        .then(function(regions) {
          return _getEc2Instances(regions).then(function(inventory) {
            console.log(inventory);
            return inventory;
          });
        }).then(function(inventory) {
          _writeToCache(inventory, settings.cachePathCache);
        }).catch(function(e) {
          console.log(e);
        });
  ...
  var _getEc2Instances = function(regions) {
    // Collect all ec2 instances for all regions
    return new Promise(function(resolve, reject) {
      var inventory = [];
      var instances = [];
      regions.forEach(function(region) {
        instances = _getEc2InstancesByRegion(region);
        inventory.push(instances);
      });
      resolve(instances);
    });
  };
  ...
  var _getEc2InstancesByRegion = function(region) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (settings.ec2InstanceFilters) {
        // We need settings.ec2InstanceFilters before continuing.
        settings.ec2InstanceFilters.forEach(function(filter) {
      ...
      // Request instances
      describeInstances(params).then(function(data) {
    ...
    /*resolve([{
      region: region,
      id: 12345,
      name: "host1.somewhere.com"
    }, {
      region: region,
      id: 12234,
      name: "host2.somewhere.com"
    }, {
      region: region,
      id: 12223,
      name: "host3.somewhere.com"
    }, {
      region: region,
      id: 12222,
      name: "host4.somewhere.com"
    }, {
      region: region,
      id: 12333,
      name: "host5.somewhere.com"
    }, {
      region: region,
      id: 12334,
      name: "host6.somewhere.com"
    }, {
      region: region,
      id: 12333,
      name: "host7.somewhere.com"
    }, {
      region: region,
      id: 12344,
      name: "host8.somewhere.com"
    }]);*/
  };
  ...
  */
  ...
  var _useRoute53RecordsCheck = function() {
    ...
    /* 
       ...
       This enables us to ensure that settings.route53records is set
       before continuring.
    */
