...
*/
  ...
  var _filterZones = function(zones) {
    var filteredZones = [];
  ...
  var _getZoneRr = function(zone) {
    return new Promise(function(resolve, reject) {
      ...
      allRrSets(params).then(function(rrset) {
        rrsets.push(rrset.ResourceRecordSets);
      });
      resolve(rrsets);
    });
  }

  var _getResourceRecords = function(zones) {
    return new Promise(function(resolve, reject) {
      var route53 = new AWS.Route53();
      var rrsets = [];
      zones.forEach(function(zone) {
        _getZoneRr(zone).then(function(rrsets) {
          resolve(rrsets);
        });
      });
    });
  ...
  var _getRoute53Records = function() {
    ...
    return new Promise(function(resolve, reject) {
      allZones().then(function(zones) {
        ...
        return _filterZones(zones);
      }).then(function(zones) {
        _getResourceRecords(zones).then(function(rrsets) {
          resolve(rrsets);
        });
/*      }).then(function(rrsets) {
        console.log(rrsets);
        resolve(rrsets);*/
      }).catch(function(e) {
        reject(e);
