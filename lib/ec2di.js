...
var ec2di = function() {
  ...
  var _readSettings = function(config) {
    ...
    settings.vpcDestination_variable = config.ec2.vpc_destination_variable;
    ...
    if (pattern_include && pattern_include.length > 0) {
      settings.pattern_include = new RegExp(pattern_include);
    } else {
    ...
    if (pattern_exclude && pattern_exclude.length > 0) {
      settings.pattern_exclude = new RegExp(pattern_exclude);
    } else {
