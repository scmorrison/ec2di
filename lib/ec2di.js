...
var ec2di = function() {
    ...
    return new Promise(function(resolve, reject) {
      ...
      _useRoute53RecordsCheck()
        .then(function() {
          ...
          return _getAllEc2Instances(regions);
        }).then(function(inventory) {
          // Finally, write everything out to the cache
          _writeToCache(inventory, settings.cache_path_cache);
        }).catch(function(e) {
          console.log(e);
        });
  ...
  var _getAllEc2Instances = function(regions) {
  ...
  var _getInstance = function(instanceid) {
  ...
  var _addInstance = function(instance, region) {
    ...
    if (instance.SubnetId) {
      ...
      */
      ...
      if (settings.vpc_destination_variable === "ip_address") {
        var dest = instance["PublicIpAddress"];
      } else {
        var dest = instance[changeCase.pascalCase(settings.vpc_destination_variable)];
      }
      ...
      */
      ...
      var dest = instance[changeCase.pascalCase(settings.destination_variable)];
    }
...
*/
  ...
  var _pushGroup = function(obj, key, element) {
    ...
    //var parent_group = key in obj || (obj[key] = {});
    ...
    var child_groups =  in parent_group || (parent_group[key] = []);
    if (!(element in child_groups)) {
      child_groups.push(element);
    }
    console.log(child_groups);
    return parent_group;
  };
